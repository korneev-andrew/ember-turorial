...
module('Acceptance | ember tutorial', function(hooks) {
  ...
  test('visiting indexUrl /', async function(assert) {
    await visit('/');
  ...
  test('clicking on tomster yields going back to index route', async function(assert) {
    await visit('/about');
    await click('.jumbo a.tomster');
  ...
  test('visiting /rentals/grand-old-mansion', async function(assert) {
    ...
    const button = find('.share.button')! as HTMLAnchorElement;
